...
import torch
from .qwen2 import mlp_forward, rmsnorm_forward, decoder_layer_forward

module = importlib.import_module('transformers.models.qwen2_vl.modeling_qwen2_vl')
module.Qwen2MLP.forward = mlp_forward
module.Qwen2RMSNorm.forward=  rmsnorm_forward
module.Qwen2VLDecoderLayer.forward = decoder_layer_forward
        ...
        **kwargs,
        ...
        if labels is not None:
            ...
            if not hasattr(self, "extra_ignored_labels") or shift_logits.size(1) > self.max_seq_length:
                ...
                self.extra_ignored_labels = torch.full((self.max_seq_length, 1), -100, device = self.device)
...
module.Qwen2VLForConditionalGeneration.forward = causal_forward
trigger = None
